...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0-WKUP     ------> ADC1_IN0
    */
    HAL_GPIO_DeInit(DISTANCE_REGULATOR_GPIO_Port, DISTANCE_REGULATOR_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB7     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(I2C1_SLC_LASER1_GPIO_Port, I2C1_SLC_LASER1_Pin);

    HAL_GPIO_DeInit(I2C1_SDA_LASER1_GPIO_Port, I2C1_SDA_LASER1_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB3     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(I2C2_SCL_LASER2_GPIO_Port, I2C2_SCL_LASER2_Pin);

    HAL_GPIO_DeInit(I2C2_SDA_LASER2_GPIO_Port, I2C2_SDA_LASER2_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PB4     ------> I2C3_SDA
    */
    HAL_GPIO_DeInit(I2C3_SCL_NHD_GPIO_Port, I2C3_SCL_NHD_Pin);

    HAL_GPIO_DeInit(I2C3_SDA_NHD_GPIO_Port, I2C3_SDA_NHD_Pin);
